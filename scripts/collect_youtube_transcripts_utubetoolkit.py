#!/usr/bin/env python3
"""Collect YouTube transcripts through UTubeToolkit's online caption endpoint."""
...
PROVIDER_NAME = "UTubeToolkit"
PROVIDER_SLUG = "utubetoolkit"
PROVIDER_PAGE = "https://utubetoolkit.com/"
PROVIDER_ENDPOINT = "https://utubetoolkit.com/api/transcript/"
...
def write_transcript(args: argparse.Namespace, video: dict[str, Any], provider_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    payload = {
        ...
        "provider": {
            ...
            "extraction": "Direct online caption endpoint exposed by UTubeToolkit web app",
        },
...
def collect(args: argparse.Namespace) -> list[dict[str, Any]]:
    ...
    for video in selected:
        ...
        if isinstance(payload, dict):
            ...
            row["provider_success"] = payload.get("success")
...
def main() -> None:
    args = parse_args()
    rows = collect(args)
    manifest_path = args.target_dir / "evidence" / "media" / "provider-probes" / "utubetoolkit-manifest.json"
